...
public class jsonDeleteWareHouses {

	warehouseM model;
	Context c;
	
	public jsonDeleteWareHouses(Context c, warehouseM model,String url) {
		this.c=c;
		this.model=model;
	...
	public static String DELETE(String url, warehouseM model){
